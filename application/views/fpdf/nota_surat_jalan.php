...
$q = mysqli_query($koneksi,"SELECT total, bayar, kembali, status, kurang, tempo FROM penjualan INNER JOIN tmp_penjualan ON penjualan.id_penjualan=tmp_penjualan.id_penjualan ORDER by penjualan.id_penjualan DESC LIMIT 1");
...
$pdf->SetFont('Arial','',10);
	...
	$pdf->Cell(75, 8, "Cara Bayar : ".$data2['status'], 0, 0,'L');
